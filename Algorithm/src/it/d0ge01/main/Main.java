	...
	private static void menu() throws IOException {
		...
		while ( cond ) {
			...
			if ( ch == 1 ) {
				...
				if ( ob.checkN() )
					System.out.println("Si � un numero di Armstrong..");
				else
					System.out.println("Non � un numero di Armstrong ");
			}
			...
			if ( ch == 3 ) {
				...
				if ( ob.real ) {
					System.out.println("La prima radice � " + ob.radici(0));
					System.out.println("La seconda radice � " + ob.radici(1));
				}
			}
			...
			if ( ch == 4 ) {
				...
				n = Util.inputInt();
				Fatt ob = new Fatt(n);
				System.out.println("Il fattoriale � " + ob.fatt());
			}
